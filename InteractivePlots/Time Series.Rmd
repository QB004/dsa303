...
```{r}
oso_pri_hist <- readRDS("InteractivePlots/oso_pri_hist.rds")
obesity_data_sf_2023_OSO <- readRDS("InteractivePlots/obesity_data_sf_2023_OSO.rds")
ura_regions_map <- readRDS("InteractivePlots/ura_regions_map.rds")
oso_hist_geom <- readRDS("InteractivePlots/oso_hist_geom.rds")
pri_sch_map <- readRDS("InteractivePlots/pri_sch_map.rds")
```
...
#Maps:
tmap_arrange(pri_map_z_decrease1, pri_map_z_increase, nrow = 1)
```

...
# Overview of overweight prevalence levels in primary and secondary schools
obesity_pri_sch <- obesity_filtered %>% filter(LEVEL == "PRIMARY")
obesity_sec_sch <- obesity_filtered %>% filter(LEVEL == "SECONDARY")

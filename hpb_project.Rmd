...
pri_bivariate_map <-ura_planning_areas_map +
  tm_shape(pri_bc) +
  tm_polygons(fill = "bivariate_class", pallete = bivariate_colors, title = "Bivariate Categories (CCA - Obesity)") +
  tm_layout(legend.position = c("right", "bottom")) +
...
#note - unable to use 'values' instead of 'pallete' for bivariate_colors because it wasn't preserving the predetermined colors. Instead, it was using it's own color scheme which ruined the bivariate chloropleth map. These maps are still using tmap v3 as a result.

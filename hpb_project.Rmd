...
Local Moran's I statistic may be biased towards border regions (indicatre clustering in border regions with less neighbours even if clustering may not be present)
```{r}
...
moran.test(obesity_data$TIER_SCORE, cluster_wlist)
```

...
map3 <- tm_shape(nb2lines(knn3_nb_pri, coords = st_geometry(obesity_pri_sch))) + 
  ...
  tm_lines(lwd = 1.5, col = "green") + 
  tm_shape(nb2lines(knn1_nb_pri, coords = st_geometry(obesity_pri_sch))) +
  tm_lines(lwd = 2, col = "black") +
  tm_legend(c("k=1", "k=2", "k=3"), col=c("pink", "red", "red4"), lty=1) +
  obesity_pri_sch %>% tm_shape() + tm_symbols(size = 0.25) +
  tm_add_legend(type = "lines", labels = "k=3", lwd = 1, col = "red") +
  tm_add_legend(type = "lines", labels = "k=2", lwd = 1.5, col = "green") +
  tm_add_legend(type = "lines", labels = "k=1", lwd = 2, col = "black") +
  tm_title("k nearest neighbour (Primary)")

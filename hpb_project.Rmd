...
summary(lm.all_sec)
```
For the primary school variables, the intercept is the most statistically significant with p-value close to 0. Other statistcally significant variables include is_coed_sch (p-value <0.01), is_coed_sch (p-value<0.05), while moderately significant variables are is_govt_sch and num_food_outlets (p-value<0.1)

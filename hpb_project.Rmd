...
We recommend skipping to the last sub-section in this section on spatial clustering to examine the autocorrelation of our selected spatial weights matrix.

## Region based analysis (Contiguous region neighbours)

We examine spatial autocorrelation of URA defined regions.
...
There are 323 URA subzones in Singapore, of which 115 contain primary schools, and 100 contain secondary schools. As there were a few non-contiguous subzones, 

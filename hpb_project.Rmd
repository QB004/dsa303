...
We recommend skipping to the last sub-section to examine the autocorrelation of our selected spatial weights matrix, as well as our results from the spatial clustering analysis of childhood obesity in Singapore.
...
Based on Local Moran's I (at the 1% significance level) and Local Getis-Ord's G (z-value < 0) (we filter for LMORANZ >= 2.576, GO_STAT < 0 to identify high-high clusters and schools with high positive spatial autocorrelation), the following primary schools (circled in green in the map), and their respective SOI neighbours, were identified as Low-Low overweight prevalence clusters:
...
Based on Local Moran's I (at the 1% significance level) and Local Getis-Ord's G (z-value < 0), the following primary schools (and their respective SOI neighbours) were identified as Low-Low overweight prevalence clusters:
...
pri_bivariate_food_map <-ura_planning_areas_map +
  ...
  tm_polygons(fill = "bivariate_class", palette = bivariate_colors, title = "Bivariate Categories (Food - Obesity)") +
